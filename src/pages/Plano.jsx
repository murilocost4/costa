    ...
    return (
        ...
        <header className="w-full flex justify-between items-center px-24 h-20 border-b-2">
            ...
            <nav className="flex gap-10">
                <a href="#planos" className="scroll-smooth">Planos Assistenciais</a>
                <a href="#contact" className="scroll-smooth">Contato</a>
                <a href="">FAQs</a>
            </nav>
        </header>
        <main className="flex-col">
            <section className="grid-flow-col gap-16 items-center text-center md:text-left md:pl-16 mt-32 md:m-16 md:border-2 md:flex">
                <div className="flex-col px-6 md:p-0 md:w-1/2">
                    ...
                    <div className="flex gap-6 w-fit mx-auto md:mx-0">
                        <a href="#planos" className="scroll-smooth"><Button title="Saiba Mais" bg={1}/></a>
                        <a href="#contact" className="scroll-smooth"><Button title="Contato" bg={2}/></a>
                    </div>
                </div>
            ...
            <section id="planos" className="flex-col mt-48 justify-center ">
                ...
                <div className="flex flex-col justify-center w-fit md:flex-row gap-16 md:gap-32">
                ...
                <div className="w-fit mx-auto mt-14">
                    <a href="/planodetails"><Button title="Mais informações" bg={1}/></a>
                </div>
            </section>
            <section id="contact" className="flex-col text-center mb-40 justify-center">
                <p className="text-2xl mt-32 mb-12">Contato</p>
                <div className="flex flex-col md:flex-row md:m-auto gap-8 justify-center items-center md:items-baseline w-fit px-10">
                    <div className="flex-col justify-center w-fit md:w-52">
                        <svg className="m-auto mb-2 md:mb-6" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 32 32">
                        ...
                        <p className="text-xl mb-2 md:mb-4 text-slate-700">Endereço</p>
                        <p className="text-slate-500">Rua Marechal Deodoro, 2356, Centro, Taquari, RS</p>
                    </div>
                    <div className="flex-col justify-center w-fit md:w-52">
                        <svg className="m-auto mb-2 md:mb-6" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 256 256">
                        ...
                        <p className="text-xl mb-2 md:mb-4 text-slate-700">Ligue</p>
                        <p className="text-slate-500">+55 (54)2129-4040</p>
                    </div>
                    <div className="flex-col justify-center w-fit md:w-52">
                        <svg className="m-auto mb-2 md:mb-6" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 24 24">
                        ...
                        <p className="text-xl mb-2 md:mb-4 text-slate-700">Whatsapp</p>
                        <p className="text-slate-500">+55 (54)2129-4040</p>
                    </div>
                    <div className="flex-col justify-center w-fit md:w-52">
                        <svg className="m-auto mb-2 md:mb-6" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 24 24">
                        ...
                        <p className="text-xl mb-2 md:mb-4 text-slate-700">Instagram</p>
                        <p className="text-slate-500">@planocosta</p>
                    </div>
                    <div className="flex-col justify-center w-fit md:w-52">
                        <svg className="m-auto mb-2 md:mb-6" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 24 24">
                        ...
                        <p className="text-xl mb-2 md:mb-4 text-slate-700">Facebook</p>
                        <p className="text-slate-500">Plano Costa</p>
                    </div>
                </div>
            </section>
        </main>
